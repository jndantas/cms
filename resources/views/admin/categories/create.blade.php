...
@section('title')
{{ isset($category) ? 'Editar Categoria' : 'Criar nova categoria'}}
@endsection
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ isset($category) ? 'Editar Categoria' : 'Criar nova categoria'}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">{{ isset($category) ? 'Editar Categoria' : 'Adicionar categoria'}}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-8">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ isset($category) ? 'Editar Categoria' : 'Criar nova categoria'}}</h3>
                </div>
                    <!-- /.card-header -->
                    <!-- form start -->
